...
/* The life snapshot's reader: parse, staleness, the brief and the three
 * reader lines. Pure; only `src/team/snapshot.ts` touches the adapter. */
export * from '../src/team/snapshotParse';
...
export * from '../src/view/paneActions';
