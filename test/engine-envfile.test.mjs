...
import {
  DEFAULT_ENV_FILE_PATH, ENV_KEY_FOR, cleanVaultPath, parseEnvFile, upsertEnvLine, readEnvKey, writeEnvKey,
} from './build/pure.mjs';
...
test('cleanVaultPath trims, strips a leading ./ or /, and turns backslashes around', () => {
