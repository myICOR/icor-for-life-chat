...
import {
  ...
  resolveTransports, saveOwnKeySettings, secretStorageOf, testProviderKey, writeProviderKey,
} from '../engine';
  ...
  private renderEnvPathRow(container: HTMLElement, block: HTMLElement, settings: OwnKeySettings): void {
    new Setting(block)
      ...
      .addText((t) => {
        ...
        // focus and read a half-typed path.
        t.inputEl.addEventListener('change', () => this.render(container));
      });
  }
