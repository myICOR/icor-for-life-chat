...
The built `main.js` also contains `@anthropic-ai/claude-agent-sdk`,
Copyright (c) Anthropic PBC, which is not under MIT; forks that
redistribute `main.js` redistribute it on Anthropic's terms.
